...
Created at: 2024\-10\-16 14:16:58
...
- [type Role](<#Role>)
- [type Schema](<#Schema>)
  - [func ReflectSchema\(a any\) \(\*Schema, error\)](<#ReflectSchema>)
...
## func [ToSnakeCase](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1931>)
...
## type [ChatCompletionChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L186-L203>)
...
## type [ChatCompletionMessage](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L71-L79>)
...
### func \(ChatCompletionMessage\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L286>)
...
### func \(\*ChatCompletionMessage\) [UnmarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L315>)
...
## type [ChatCompletionRequest](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L124-L146>)
...
## type [ChatCompletionResponse](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L205-L214>)
...
### func \(\*ChatCompletionResponse\) [SetHeader](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L358>)
...
## type [ChatCompletionResponseFormat](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L98-L103>)
...
## type [ChatCompletionResponseFormatJSONSchema](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L106-L122>)
...
## type [ChatCompletionResponseFormatType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L96>)
...
## type [ChatCompletionStream](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L262-L264>)
...
## type [ChatCompletionStreamChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L223-L227>)
...
## type [ChatCompletionStreamChoiceDelta](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L216-L221>)
...
## type [ChatCompletionStreamResponse](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L244-L258>)
...
## type [ChatMessageImageURL](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L59-L62>)
...
## type [ChatMessagePart](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L65-L69>)
...
## type [ChatMessagePartType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L49>)
...
### func \(\*Client\) [CreateChatCompletion](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L377-L380>)
...
### func \(\*Client\) [CreateChatCompletionJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L431-L435>)
...
### func \(\*Client\) [CreateChatCompletionStream](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L405-L408>)
...
### func \(\*Client\) [CreateTranscription](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L106-L109>)
...
### func \(\*Client\) [CreateTranslation](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L116-L119>)
...
### func \(\*Client\) [Moderate](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L199-L202>)
...
### func \(\*Client\) [MustCreateChatCompletion](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L365-L368>)
...
## type [FinishReason](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L184>)
...
### func \(FinishReason\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L348>)
...
## type [FunctionCall](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L89-L92>)
...
## type [FunctionDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L266-L270>)
...
## type [HarmfulCategory](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L20>)
...
## type [ImageURLDetail](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L45>)
...
<a name="LogProb"></a>
## type [LogProb](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L172-L177>)
...
<a name="LogProbs"></a>
## type [LogProbs](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L179-L181>)
...
<a name="Moderation"></a>
## type [Moderation](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L27-L30>)
...
## type [ModerationRequest](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L21-L25>)
...
## type [ParameterDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L272-L277>)
...
## type [PromptAnnotation](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L55-L57>)
...
## type [PromptFilterResult](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L229-L231>)
...
## type [PropertyDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L279-L282>)
...
<a name="Role"></a>
## type [Role](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L53>)
...
<a name="Schema"></a>
## type [Schema](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L59-L851>)
...
<a name="ReflectSchema"></a>
### func [ReflectSchema](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L26>)
...
### func \(\*Schema\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1863>)
...
### func \(\*Schema\) [UnmarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1845>)
...
## type [StreamOptions](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L236-L242>)
...
<a name="Tool"></a>
## type [Tool](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L152-L155>)
...
<a name="ToolCall"></a>
## type [ToolCall](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L81-L87>)
...
<a name="ToolChoice"></a>
## type [ToolChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L157-L160>)
...
## type [ToolFunction](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L162-L164>)
...
<a name="ToolType"></a>
## type [ToolType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L150>)
...
## type [TopLogProbs](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L166-L170>)
