...
Created at: 2024\-10\-02 14:05:16
...
- [type Schema](<#Schema>)
  ...
  - [func ReflectionFromType\(a any\) \(\*Schema, error\)](<#ReflectionFromType>)
...
## func [ToSnakeCase](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1936>)
...
## type [AudioRequest](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L35-L43>)
...
### func \(\*AudioResponse\) [SetHeader](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L84>)
...
## type [AudioResponseFormat](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L29>)
...
## type [ChatCompletionChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L182-L199>)
...
## type [ChatCompletionMessage](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L68-L76>)
...
### func \(ChatCompletionMessage\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L282>)
...
### func \(\*ChatCompletionMessage\) [UnmarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L311>)
...
## type [ChatCompletionRequest](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L121-L142>)
...
## type [ChatCompletionResponse](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L201-L210>)
...
### func \(\*ChatCompletionResponse\) [SetHeader](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L354>)
...
## type [ChatCompletionResponseFormat](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L95-L100>)
...
## type [ChatCompletionResponseFormatJSONSchema](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L103-L119>)
...
## type [ChatCompletionResponseFormatType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L93>)
...
## type [ChatCompletionStream](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L258-L260>)
...
## type [ChatCompletionStreamChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L219-L223>)
...
## type [ChatCompletionStreamChoiceDelta](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L212-L217>)
...
## type [ChatCompletionStreamResponse](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L240-L254>)
...
## type [ChatMessageImageURL](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L56-L59>)
...
## type [ChatMessagePart](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L62-L66>)
...
## type [ChatMessagePartType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L46>)
...
<a name="Client"></a>
## type [Client](<https://github.com/conneroisu/groq-go/blob/main/client.go#L23-L34>)
...
<a name="NewClient"></a>
### func [NewClient](<https://github.com/conneroisu/groq-go/blob/main/client.go#L72>)
...
### func \(\*Client\) [CreateChatCompletion](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L359-L362>)
...
### func \(\*Client\) [CreateChatCompletionJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L406-L410>)
...
### func \(\*Client\) [CreateChatCompletionStream](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L381-L384>)
...
### func \(\*Client\) [CreateTranscription](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L104-L107>)
...
### func \(\*Client\) [CreateTranslation](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L114-L117>)
...
### func \(\*Client\) [Moderate](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L197-L200>)
...
## type [FinishReason](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L180>)
...
### func \(FinishReason\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L344>)
...
## type [FunctionCall](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L86-L89>)
...
## type [FunctionDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L262-L266>)
...
## type [HarmfulCategory](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L18>)
...
## type [ImageURLDetail](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L42>)
...
<a name="LogProb"></a>
## type [LogProb](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L168-L173>)
...
<a name="LogProbs"></a>
## type [LogProbs](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L175-L177>)
...
<a name="Moderation"></a>
## type [Moderation](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L25-L28>)
...
## type [ModerationRequest](<https://github.com/conneroisu/groq-go/blob/main/moderation.go#L19-L23>)
...
<a name="Opts"></a>
## type [Opts](<https://github.com/conneroisu/groq-go/blob/main/client.go#L50>)
...
### func [WithBaseURL](<https://github.com/conneroisu/groq-go/blob/main/client.go#L111>)
...
<a name="WithClient"></a>
### func [WithClient](<https://github.com/conneroisu/groq-go/blob/main/client.go#L104>)
...
<a name="WithLogger"></a>
### func [WithLogger](<https://github.com/conneroisu/groq-go/blob/main/client.go#L118>)
...
## type [ParameterDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L268-L273>)
...
## type [PromptFilterResult](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L225-L227>)
...
## type [PropertyDefinition](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L275-L278>)
...
## type [RateLimitHeaders](<https://github.com/conneroisu/groq-go/blob/main/client.go#L37-L44>)
...
<a name="ResetTime"></a>
## type [ResetTime](<https://github.com/conneroisu/groq-go/blob/main/client.go#L47>)
...
### func \(ResetTime\) [String](<https://github.com/conneroisu/groq-go/blob/main/client.go#L296>)
...
### func \(ResetTime\) [Time](<https://github.com/conneroisu/groq-go/blob/main/client.go#L301>)
...
<a name="Role"></a>
## type [Role](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L50>)
...
<a name="Schema"></a>
## type [Schema](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L66-L855>)
...
<a name="ReflectionFromType"></a>
### func [ReflectionFromType](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L57>)
...
### func \(\*Schema\) [MarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1868>)
...
### func \(\*Schema\) [UnmarshalJSON](<https://github.com/conneroisu/groq-go/blob/main/schema.go#L1850>)
...
<a name="Segments"></a>
## type [Segments](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L62-L74>)
...
## type [StreamOptions](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L232-L238>)
...
<a name="Tool"></a>
## type [Tool](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L148-L151>)
...
<a name="ToolCall"></a>
## type [ToolCall](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L78-L84>)
...
<a name="ToolChoice"></a>
## type [ToolChoice](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L153-L156>)
...
## type [ToolFunction](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L158-L160>)
...
<a name="ToolType"></a>
## type [ToolType](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L146>)
...
## type [TopLogProbs](<https://github.com/conneroisu/groq-go/blob/main/chat.go#L162-L166>)
...
## type [TranscriptionTimestampGranularity](<https://github.com/conneroisu/groq-go/blob/main/audio.go#L33>)
...
<a name="Usage"></a>
## type [Usage](<https://github.com/conneroisu/groq-go/blob/main/client.go#L125-L129>)
