...
//
// Created at: 2024-12-16 09:48:16
//
...
func TestChatModelsLlama3370BSpecdec(t *testing.T) {
	...
	a.NoError(err, "CreateChatCompletionJSON error")
	if len(response.Choices[0].Message.Content) == 0 {
		t.Errorf("response.Choices[0].Message.Content is empty for model Llama3370BSpecdec calling CreateChatCompletion")
	}
}
...
func TestChatModelsLlama3370BVersatile(t *testing.T) {
	...
	a.NoError(err, "CreateChatCompletionJSON error")
	if len(response.Choices[0].Message.Content) == 0 {
		t.Errorf("response.Choices[0].Message.Content is empty for model Llama3370BVersatile calling CreateChatCompletion")
	}
}
