...
func TestChatModels(t *testing.T) {
	...
	tests := []func(t *testing.T){
		...
		func(t *testing.T) {
			...
			a.NotEmpty(response.Choices[0].Message.Content, "response.Choices[0].Message.Content is empty")
		},
		...
		// TestLlama3290BVisionPreview tests the Llama3290BVisionPreview model.
		//
		// It ensures that the model is supported by the groq-go library and the groq
		// API. // and the operations are working as expected for the specific model type.
		func(t *testing.T) {
