...
// RequestOption is an option for the requests made by the groq API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/conneroisu/groq-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.groq.com/")
}
