...
import (
	...
	"github.com/conneroisu/groq-go/internal/apierror"
	"github.com/conneroisu/groq-go/internal/apiform"
	"github.com/conneroisu/groq-go/internal/apiquery"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Groq/Go %s", internal.PackageVersion),
	}
}
